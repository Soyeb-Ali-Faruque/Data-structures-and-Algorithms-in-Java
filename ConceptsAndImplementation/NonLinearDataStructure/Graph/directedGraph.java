...
//            this.dest=dest;
//        }
//        Edge(T sourc,T dest,int weight){
//            this.sourc=sourc;
//            this.dest=dest;
//            this.weight = weight;
//        }
...
//        }else System.out.println("vertex not found");
//    }
//    public void addEdge(T sourc, T dest,int weight){
//        if(hasVertex(sourc) && hasVertex(dest)){
//            graph.get(sourc).add(new Edge(sourc,dest,weight));
//            countEdges++;
//        }else System.out.println("vertex not found");
//    }
...
//
//
//  //----------------------------kahns algorithm(for cycle detection and topological order/sort )-----------//
//
...
//
//    //It is only works for DAG based graph
//    public HashMap<T,Integer> topoBasedShortestPath(T source){
//        if(this.hasCycle()){
//            System.out.println("Operation discarded. This graph contains cycle!");
//            return;
//        }
